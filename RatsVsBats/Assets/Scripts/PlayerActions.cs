...
public partial class @PlayerActions: IInputActionCollection2, IDisposable
{
    ...
    ""controlSchemes"": []
        ...
        m_Game_Sigile = m_Game.FindAction("Sigile", throwIfNotFound: true);
    ...
    private readonly InputAction m_Game_Sigile;
    ...
    public struct GameActions
    {
        ...
        public InputAction @Sigile => m_Wrapper.m_Game_Sigile;
        ...
        public void AddCallbacks(IGameActions instance)
        {
            ...
            @Sigile.started += instance.OnSigile;
            @Sigile.performed += instance.OnSigile;
            @Sigile.canceled += instance.OnSigile;
    ...
    public interface IGameActions
    {
        ...
        void OnSigile(InputAction.CallbackContext context);
